        ...
        <div className="flex flex-col md:flex-row-reverse gap-12">
          ...
          <div className="flex-1 md:text-left">
            ...
            <p className="text-muted-foreground mb-6 text-justify">
              ...
              My expertise includes React, Next.js, JavaScript, Node.js, and cloud platforms.
              I&apos;m dedicated to developing clean, efficient solutions to complex problems.
...
const ProfileImage = ({
  ...
  <div className={cn("mt-10 w-48 h-48 md:w-64 md:h-64", className)} {...props}>
    <div className="relative w-full h-full rounded-2xl overflow-hidden bg-accent">
      <Image src="/profile.webp" alt="mark's profile picture" className="object-cover" fill />
    </div>
  </div>
);
