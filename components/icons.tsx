...
export const LinkedInLogo = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      className="fill-current"
      d="M22.23 0H1.77C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.77 24h20.46c.978 0 1.77-.773 1.77-1.729V1.729C24 .774 23.208 0 22.23 0ZM7.12 20.452H3.556V9h3.564v11.452ZM5.338 7.577a2.063 2.063 0 1 1 0-4.127 2.063 2.063 0 0 1 0 4.127ZM20.452 20.452h-3.564v-5.568c0-1.327-.025-3.034-1.848-3.034-1.848 0-2.13 1.44-2.13 2.927v5.675h-3.564V9h3.422v1.561h.049c.477-.903 1.637-1.848 3.37-1.848 3.6 0 4.267 2.37 4.267 5.452v6.287Z"
    />
  </svg>
);
...
export const HashnodeLogo = (props: SVGProps<SVGSVGElement>) => (
  <svg
    role="img"
